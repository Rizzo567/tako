...
/* ───────────────── currency (locale-aware per ?lang=) ───────────────── */
const TAKO_LOCALE = { it: 'it-IT', en: 'en-IE', es: 'es-ES', de: 'de-DE' };
const LANG = (() => { try { const l = new URLSearchParams(location.search).get('lang'); return ['it', 'en', 'es', 'de'].includes(l) ? l : 'it'; } catch (e) { return 'it'; } })();
const _eur = new Intl.NumberFormat(TAKO_LOCALE[LANG] || 'it-IT', { style: 'currency', currency: 'EUR' });
...
Object.assign(window, {
  eur, LANG, ALLERGENS, ALLERGEN_MAP, dishStyle,
